...
// ============================================================
// STRUKTUR ASLI (ORIGINAL) - LOGIN PASTI AMAN
// ============================================================
...
function renderDashboard(){
    ...
    // DASHBOARD TETAP MATH.CEIL (PEMBULATAN KE ATAS)
...
// ============================================================
// LOGIKA PIALA (DIPERBAIKI: PERIODE LALU & SI A LOLOS)
// ============================================================
function openAchieverModal() {
    ...
    setTimeout(() => {
        ...
        myTeamData.forEach(mem => {
            ...
            // 1. CEK STATUS VIP SAAT PERIODE BERAKHIR
            // Hitung total tim dia pada detik terakhir periode tersebut
            const teamCountAtPeriodEnd = dls.filter(dl => new Date(dl.joinDate) <= endP).length;
            
            // Si A (Awal 0, Akhir 5) -> teamCountAtPeriodEnd = 5 -> Lolos Syarat VIP
            ...
            // 3. TARGET (Math.ceil)
            // Si A (Base 0 -> Total 1). 50% dari 1 = 0.5. Ceil(0.5) = 1.
