...
function renderDashboard(){
    ...
    let countDownTarget;
    if(i <= 15) { countDownTarget = new Date(k, j, 15, 23, 59, 59); } else { countDownTarget = new Date(k, j + 1, 0, 23, 59, 59); }
...
// [UPDATE] MODAL VIP: LOGIKA ICON "BARU" DITAMBAHKAN
...
// ====================================================================
// [UPDATE] REAL-TIME AI SIMULATOR (GENERATOR KALIMAT DINAMIS)
// ====================================================================

// BANK KATA: MENGHASILKAN RIBUAN KOMBINASI UNIK
const wordBank = {
    openings: [
        "🔥 SAYA SIAP BERTEMPUR!", 
        "⚠️ PERINGATAN KERAS!", 
        ...
        "💎 MENTAL JUTAWAN!", 
        "⚡ UPDATE PENTING!", 
        "🏆 MATA TERTUJU PADA PIALA!",
        "⚔️ SAATNYA SERANGAN BALIK!"
    ],
    conditions: [
        "Hari ini musuhmu sedang bekerja keras,",
        "Target tidak akan menunggu kamu siap,",
        "Kemiskinan sedang mengintip di depan pintu,",
        "Orang lain sudah berlari dua kali lebih cepat,",
        "Jika kamu diam sekarang, kamu akan tertinggal selamanya,",
        "Dunia tidak peduli dengan alasanmu,",
        "Ingat janji yang kamu ucapkan pada dirimu sendiri,"
    ],
    actions: [
        "maka HANCURKAN rasa malasmu sekarang!",
        "segera RAPATKAN BARISAN dan kejar ketertinggalan!",
        "buktikan kamu bukan PENGECUT!",
        "ubah keringatmu menjadi EMAS!",
        "berhenti mengeluh dan MULAI BERGERAK!",
        "tunjukkan siapa RAJA di arena ini!",
...
// FUNGSI UNTUK MERAKIT KALIMAT (AI SIMULATOR)
...
// ====================================================================
// GENERATOR PESAN GRUP (DINAMIS & REAL-TIME FEEL)
// ====================================================================
const groupWords = {
    headers: ["🔥 UPDATE MEMBARA", "🚀 INFO PENTING TIM", "⚠️ SIAGA SATU", "🏆 LAPORAN PERTEMPURAN", "⚡ KABAR DARI GARIS DEPAN"],
    intros: [
        "Keberhasilan tim bukan dinilai dari seberapa cepat kita berlari, tapi seberapa kuat kita saling menggandeng.",
        "Jangan biarkan mimpi mati hanya karena malas. INGAT ALASAN KITA MEMULAI!",
        "Pemenang bukan orang yang tak pernah gagal, tapi yang tak pernah menyerah.",
        "Satu orang bisa berjalan cepat, tapi satu tim bisa berjalan jauh.",
        "Badai ini akan membuat kita makin kuat! Jangan jadi penonton.",
        "Fokus pada solusi, bukan keluhan. Kita adalah tim pemenang!",
        "Waktu tidak bisa diputar ulang. Apa yang kita tanam hari ini, kita panen nanti."
    ],
    alerts: [
        "Tetap fokus pada pertumbuhan 50%",
        "Jangan kasih kendor, kejar target 50%",
        "Rapatkan barisan, fokus angka 50%",
        "Genjot lagi semangatnya, sasar 50%",
        "Jangan tidur nyenyak sebelum tembus 50%"
    ],
    closings: [
        "Gow .. Gaaaaass sampai tembus..!! 💪🏻",
        "Ayo buktikan kita bisa..!! 🚀",
        "Salam satu komando..!! 🔥",
        "Jangan pulang sebelum menang..!! ⚔️",
        "Hancurkan rasa malas, gasspoll..!! 💎"
    ]
};
...
window.generateShareText = function() {
    ...
    // RAKIT PESAN (Real-time Construction)
