...
function startCountdown() {
    ...
    // Jika tgl 1-15 -> Target tgl 15 jam 23:59:59
    if (d <= 15) {
        targetDate = new Date(y, m, 15, 23, 59, 59);
    } else {
        // Jika tgl 16-akhir -> Target akhir bulan jam 23:59:59
        targetDate = new Date(y, m + 1, 0, 23, 59, 59);
    }
    ...
    setInterval(() => {
        ...
        if (distance < 0) {
            timerEl.innerText = "PERIODE SELESAI";
            return;
        }
...
function openBroadcastModal() {
    ...
    const text = `🔥 *UPDATE TIM DV NAGA PERSADA* 🔥\n\n` +
                 ...
                 `"Sukses tidak datang dari apa yang kita lakukan sesekali, tapi dari apa yang kita lakukan secara konsisten."\n\n` +
