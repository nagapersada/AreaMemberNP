...
function renderDashboard(){
    ...
    // --- LOGIKA PERIODE (UNTUK STATISTIK TARGET) ---
    const h=new Date,i=h.getDate(),j=h.getMonth(),k=h.getFullYear();let l,m,n,o=!1;
    // 'm' adalah tanggal CUT-OFF periode LALU
    ...
    // --- LOGIKA COUNTDOWN (REAL-TIME KE MASA DEPAN) ---
    let countDownTarget;
    if(i <= 15) {
...
// =========================================
// GENERATOR MOTIVASI MEMBARA
// =========================================
const fieryQuotes = [
    "Jangan tidur nyenyak jika targetmu belum tercapai! Mimpimu butuh eksekusi, bukan hanya imajinasi!",
    "Sukses adalah balas dendam terbaik terhadap mereka yang meremehkanmu. BUKTIKAN SEKARANG!",
    "Hari ini Anda santai? Ingat, saingan Anda sedang berlari kencang merebut posisi puncak!",
    "Kemiskinan itu menyakitkan. Jika Anda tidak mau berjuang keras sekarang, bersiaplah menderita nanti!",
    "Ubah rasa lelahmu menjadi rupiah! Jangan cengeng, dunia tidak butuh air matamu, dunia butuh hasil kerjamu!",
    "Jadilah SINGA, bukan domba! Singa tidak menoleh saat anjing menggonggong. TERUS MAJU!",
    "Orang sukses mencari jalan, pecundang mencari alasan. Anda yang mana hari ini?",
    "Rezeki tidak akan datang ke orang yang malas! Bangun, bergerak, dan rebut apa yang seharusnya jadi milikmu!",
    "Apakah Anda puas hidup begini-begini saja? Jika tidak, BERUBAHLA! Mulai detik ini juga!",
    "Penonton hanya bisa bertepuk tangan. Pemainlah yang mendapatkan piala. JANGAN JADI PENONTON!"
];
